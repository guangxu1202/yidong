	...
	$.fn.jNice = function(options){
		...
		this.each(function(){
			...
			$('input:checkbox', this).each(function(){
				...
				$wrapper.prepend('<div href="#" class="jNiceCheckbox"></div>');
				/--* Click Handler *---/
				$(this).siblings('div.jNiceCheckbox').click(function(){
						var $a = $(this);
				...
				if (this.checked){$('div.jNiceCheckbox', $wrapper).addClass('jNiceChecked');}
			});
			*/
			/***************************
			  Radios 
			...
			*/
			...
			$('select', this).each(function(index){
				...
				var $wrapper = $(this).parent().css({zIndex: 100});
